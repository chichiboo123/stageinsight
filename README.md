...
- **✨ AI 큐레이션**: 키워드로 1차 추린 후보를 Gemini가 의미 기반으로 재정렬하고 연계 근거를 한 문장으로 제시 (호출 실패 시 키워드 결과로 자동 폴백)
- 학년군·교과 토글 필터로 원하는 성취기준만 빠르게 탐색

### 🎬 연계 추천 자료
- 공연 주제와 연결된 영화·도서 자동 추천
- **✨ AI 의미 보강**: 공연 줄거리에서 주제·정서를 분석해 정확한 검색어를 생성, 기존 TMDB·네이버 도서 검색을 더 적중률 높게 구동

### 🗂 인사이트 바구니
- 공연·성취기준·영화·도서를 바구니에 담아 수업 아이디어 정리
- **✨ AI 수업 아이디어**: 담은 성취기준·자료를 묶어 수업 개요·학습목표·활동·발문·평가 초안을 생성 → 메모로 저장
- 항목 드래그 앤 드롭 순서 변경
- 메모 작성 기능
